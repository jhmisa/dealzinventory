...
// Common international shipping countries.
// JP and PH come first because they're the two primary markets;
...
// Philippine provinces and the National Capital Region.
// Order: NCR first (Metro Manila is the most common destination), then alphabetical.
...
export type PhilippineProvince = (typeof PHILIPPINES_PROVINCES)[number]
