export const queryKeys = {
  ...
  sellGroups: {
    ...
    byCode: (code: string) => [...queryKeys.sellGroups.all, 'code', code] as const,
  },
  orders: {
    all: ['orders'] as const,
  ...
  tickets: {
    ...
    customer: (customerId: string) => [...queryKeys.tickets.all, 'customer', customerId] as const,
    order: (orderId: string) => [...queryKeys.tickets.all, 'order', orderId] as const,
    conversation: (conversationId: string) => [...queryKeys.tickets.all, 'conversation', conversationId] as const,
