...
export function AddressDisplay({ address: rawAddress, format = 'auto', className, receiverName }: AddressDisplayProps) {
    ...
    try {
      ...
      return (
        <div className={className}>
          {receiverName ? <p className="text-sm font-medium">{receiverName}</p> : null}
  ...
  const receiverLine = receiverName ? <p className="text-sm font-medium">{receiverName}</p> : null
