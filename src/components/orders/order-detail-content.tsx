...
export function OrderDetailContent({ orderId, onClose, onNavigate, isModal }: OrderDetailContentProps) {
  ...
  const { data: paymentConfirmations = [] } = usePaymentConfirmations(orderId)
