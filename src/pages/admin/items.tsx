...
// Inserts the staff-only model identifier `A3295 (MYWJ3J/A)` right after the model name
// (via withBackorderIdentifier) — kept out of getItemDescription (and thus customer offers).
