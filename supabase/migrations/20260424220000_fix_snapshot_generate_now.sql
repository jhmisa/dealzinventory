-- Fix: Allow manual "Generate Now" to bypass cron guard and regenerate same-day snapshots
-- The original function silently returned NULL when p_date was NULL on non-last-day-of-month,
-- and skipped regeneration if a snapshot already existed for the date.
