-- Fix: COALESCE item fields with product_model fields so search_available_inventory
-- returns complete data for getItemDescription() (matches Admin Items behavior).
...
BEGIN
  ...
  SELECT
    ...
    COALESCE(i.battery_health_pct, pm.battery_health_pct) AS battery_health_pct,
    i.is_unlocked,
    i.has_touchscreen,
